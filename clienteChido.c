...
int main(int argc, char * argv[]){
	...
	init_pair(2, COLOR_RED, COLOR_BLACK); //JUgadores externos
	init_pair(3, COLOR_BLUE, COLOR_BLUE); //Mapa
  ...
  if(pthread_mutex_init(&lockParaPersonajes, NULL) != 0){
	...
	personajes[0].id = 0;
	personajes[0].xPosition = 9;
	personajes[0].yPosition = 9;
	personajes[0].c = 'W';
	
	//HARCODEO MAXIMO
	//personajes[1] = malloc(sizeof(struct Personaje));
	personajes[1].id = 1;
	personajes[1].xPosition = 1;
	personajes[1].yPosition = 48;
	personajes[1].c = 'W';
